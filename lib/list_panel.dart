                  ...
                  child: Card(
                    child: ListTile(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: (){
                          FirebaseFirestore.instance.collection('packs').doc(snapshot.data!.docs[index].id).delete();
                        },
                      ),
                    ),
                  ),
          ...
          showDialog(context: context,
              builder: (_){
                return AlertDialog(
                  ...
                  content: Text('Дайте имя вашей пачке сиг типа Усманыч или типа пиписька'),
                  actions: [
                    TextField(
                      onChanged: (text){
                        _packName = text;
                    ...
                    ElevatedButton(
                        onPressed:() {
                          FirebaseFirestore.instance.collection('packs').add({'pack': _packName});
